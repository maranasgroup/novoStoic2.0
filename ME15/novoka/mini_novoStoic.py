...
#     pulp_solver = pulp.CPLEX_CMD(path=path_to_cplex,keepFiles=0, mip=1, msg=1)
    ...
    use_direction=True
    novoStoic_minFlux_relaxedRule(exchange_mets, novel_mets,project,iterations, num_steps,pulp_solver,use_direction)
    use_direction=False
    novoStoic_minFlux_relaxedRule(exchange_mets, novel_mets,project,iterations, num_steps,pulp_solver,use_direction)
...
def test_art_trial_0():
    ...
    novel_mets = {'DHARTAA': 'C[C@@H]1CC[C@H]([C@@H]2[C@H]1CCC(=C2)C)[C@@H](C)C(=O)[O-]', 'DHARTAA_ns' : 'CC1CCC(C2C1CCC(=C2)C)C(C)C(=O)[O-]', 'DHARTAAN1': 'C[C@@H]1CC[C@H](C2=CC(CC[C@@H]12)(C)OO)[C@@H](C)C(=O)[O-]', 'DHARTAAN1_ns': 'CC1CCC(C2=CC(CCC12)(C)OO)C(C)C(=O)[O-]', 'DHARTAAN2': 'CC(CC[C@H]1[C@H](C)CC[C@@H]([C@@H](C)C([O-])=O)C1=C)OO',  'DHARTAAN2_ns': 'CC(CCC1C(C)CCC(C(C)C([O-])=O)C1=C)OO', 'DHARTAAN3_ns': 'CC(CCC1C(C)CCC2C(C)C(=O)OCC12)OO', 'DHARTAAN4':'CC1CCC2C(C)C(=O)OC3C2C1CCC3(C)OO', 'N00005': 'CC1CCC2C(C)C(=O)OC3OC(C)CCC1C23', 'N00006': 'CC1CCC2C(C)C(=O)OC3OC(C)CCC1=C23', 'N00007': 'CC1CCC2C(C)C(=O)OC3OC(C)(CCC1C23)OO'}
    num_steps = 5

    iterations = 50
    project = './novoStoic_art_trial_0'

...
st.markdown(
    ...
    - EnzRank: Upadhyay V, Maranas CD (2023) Rank-ordering of known enzymes as starting points for re-engineering novel substrate activity using a convolutional neural network, Metab Eng. https://doi.org/10.1016/j.ymben.2023.06.001
